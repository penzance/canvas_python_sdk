...
def retrieve_assignments_enabled_for_grade_export_to_sis_courses(request_ctx, course_id, account_id=None, starts_before=None, ends_after=None, **request_kwargs):
    """
    Retrieve a list of published assignments flagged as "post_to_sis". Assignment group and section information are
    included for convenience.
