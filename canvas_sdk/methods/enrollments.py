...
def list_enrollments_sections(request_ctx, section_id, type=None, role=None, state=None, user_id=None, grading_period_id=None, per_page=None, **request_kwargs):
    """
    Depending on the URL given, return either (1) all of the enrollments in
    a course, (2) all of the enrollments in a section or (3) all of a user's
    enrollments. This includes student, teacher, TA, and observer enrollments.
...
def list_enrollments_users(request_ctx, user_id, type=None, role=None, state=None, grading_period_id=None, per_page=None, **request_kwargs):
    """
    Depending on the URL given, return either (1) all of the enrollments in
    a course, (2) all of the enrollments in a section or (3) all of a user's
    enrollments. This includes student, teacher, TA, and observer enrollments.
...
def enroll_user_courses(request_ctx, course_id, enrollment_user_id, enrollment_type, enrollment_role=None, enrollment_role_id=None, enrollment_enrollment_state=None, enrollment_course_section_id=None, enrollment_limit_privileges_to_course_section=None, enrollment_notify=None, enrollment_self_enrollment_code=None, enrollment_self_enrolled=None, **request_kwargs):
    """
...
def enroll_user_sections(request_ctx, section_id, enrollment_user_id, enrollment_type, enrollment_role=None, enrollment_role_id=None, enrollment_enrollment_state=None, enrollment_course_section_id=None, enrollment_limit_privileges_to_course_section=None, enrollment_notify=None, enrollment_self_enrollment_code=None, enrollment_self_enrolled=None, **request_kwargs):
    """
    Create a new user enrollment for a course or section.
...
def conclude_or_inactivate_enrollment(request_ctx, course_id, id, task=None, **request_kwargs):
    """
...
When inactive, a user will still appear in the course roster to admins, but be unable to participate.
        ...
        :return: Conclude or inactivate an enrollment
        :rtype: requests.Response (with Enrollment data)

    """

    task_types = ('conclude', 'delete', 'inactivate')
