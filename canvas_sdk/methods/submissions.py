...
def list_assignment_submissions_courses(request_ctx, course_id, assignment_id, include=None, grouped=None, per_page=None, **request_kwargs):
    ...
    include_types = ('submission_history', 'submission_comments', 'rubric_assessment', 'assignment', 'visibility', 'course', 'user')
...
def list_submissions_for_multiple_assignments_courses(request_ctx, course_id, student_ids=None, assignment_ids=None, grouped=None, grading_period_id=None, include=None, per_page=None, **request_kwargs):
    """
...
def list_submissions_for_multiple_assignments_sections(request_ctx, section_id, student_ids=None, assignment_ids=None, grouped=None, grading_period_id=None, include=None, per_page=None, **request_kwargs):
    """
    Get all existing submissions for a given set of students and assignments.
...
def grade_or_comment_on_multiple_submissions_courses_submissions(request_ctx, course_id, grade_data_student_id_posted_grade=None, grade_data_student_id_rubric_assessment=None, grade_data_student_id_text_comment=None, grade_data_student_id_group_comment=None, grade_data_student_id_media_comment_id=None, grade_data_student_id_media_comment_type=None, grade_data_student_id_file_ids=None, **request_kwargs):
    """
