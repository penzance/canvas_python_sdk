...
def list_conversations(request_ctx, scope=None, filter=None, filter_mode=None, interleave_submissions=None, include_all_conversation_ids=None, include=None, per_page=None, **request_kwargs):
    """
...
ids of all conversations under this scope/filter in the same order.
        ...
        :param include: (optional) "participant_avatars":: Optionally include an "avatar_url" key for each user participanting in the conversation
    ...
    include_types = ('participant_avatars')
...
def edit_conversation(request_ctx, id, conversation_workflow_state=None, conversation_subscribed=None, conversation_starred=None, scope=None, filter=None, filter_mode=None, **request_kwargs):
    """
