...
def show_global_notification(request_ctx, account_id, user_id, id, **request_kwargs):
    """
    ...
    A notification that has been closed by the user will not be returned
        ...
        :type id: string
        :return: Show a global notification
...
def update_global_notification(request_ctx, account_id, id, account_notification_subject=None, account_notification_message=None, account_notification_start_at=None, account_notification_end_at=None, account_notification_icon=None, account_notification_roles=None, **request_kwargs):
    """
    Update global notification for an account.
        ...
        :param account_notification_start_at: (optional) The start date and time of the notification in ISO8601 format.
e.g. 2014-01-01T01:00Z
        :type account_notification_start_at: DateTime or None
        :param account_notification_end_at: (optional) The end date and time of the notification in ISO8601 format.
e.g. 2014-01-01T01:00Z
...
Example:
  account_notification_roles: ["StudentEnrollment", "TeacherEnrollment"]
        :type account_notification_roles: array or None
        :return: Update a global notification
        :rtype: requests.Response (with void data)
