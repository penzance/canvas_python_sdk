...
def abort_sis_import(request_ctx, account_id, id, **request_kwargs):
    """
...
def abort_all_pending_sis_imports(request_ctx, account_id, **request_kwargs):
    """
    Abort already created but not processed or processing SIS imports.
        ...
        :param account_id: (required) ID
        :type account_id: string
        :return: Abort all pending SIS imports
