...
def list_your_groups(request_ctx, context_type=None, include=None, per_page=None, **request_kwargs):
    """
    Returns a list of active groups for the current user.
        ...
        :param include: (optional) - "tabs": Include the list of tabs configured for each group.  See the
...
def list_groups_available_in_context_accounts(request_ctx, account_id, only_own_groups=None, include=None, per_page=None, **request_kwargs):
    """
...
def list_groups_available_in_context_courses(request_ctx, course_id, only_own_groups=None, include=None, per_page=None, **request_kwargs):
    """
    Returns the list of active groups in the given context that are visible to user.
...
- "tabs": Include the list of tabs configured for each group.  See the
  {api:TabsController#index List available tabs API} for more information.
    ...
    include_types = ('permissions', 'tabs')
    utils.validate_attr_is_acceptable(include, include_types)
