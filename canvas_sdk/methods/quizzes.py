...
def create_quiz(request_ctx, course_id, quiz_title, quiz_quiz_type, quiz_description=None, quiz_assignment_group_id=None, quiz_time_limit=None, quiz_shuffle_answers=None, quiz_hide_results=None, quiz_show_correct_answers=None, quiz_show_correct_answers_at=None, quiz_hide_correct_answers_at=None, quiz_allowed_attempts=None, quiz_scoring_policy=None, quiz_one_question_at_a_time=None, quiz_cant_go_back=None, quiz_access_code=None, quiz_ip_filter=None, quiz_due_at=None, quiz_lock_at=None, quiz_unlock_at=None, quiz_published=None, **request_kwargs):
    """
    Create a new quiz for this course.
        ...
        :param quiz_quiz_type: (required) The type of quiz.
        :type quiz_quiz_type: string
        :param quiz_description: (optional) A description of the quiz.
        :type quiz_description: string or None
        :param quiz_assignment_group_id: (optional) The assignment group id to put the assignment in. Defaults to the top assignment group in the course. Only valid if the quiz is graded, i.e. if quiz_type is "assignment" or "graded_survey".
        :type quiz_assignment_group_id: integer or None
        :param quiz_time_limit: (optional) Time limit to take this quiz, in minutes. Set to null for no time limit. Defaults to null.
        :type quiz_time_limit: integer or None
        :param quiz_shuffle_answers: (optional) If true, quiz answers for multiple choice questions will be randomized for each student. Defaults to false.
        :type quiz_shuffle_answers: boolean or None
        :param quiz_hide_results: (optional) Dictates whether or not quiz results are hidden from students. If null, students can see their results after any attempt. If "always", students can never see their results. If "until_after_last_attempt", students can only see results after their last attempt. (Only valid if allowed_attempts > 1). Defaults to null.
        :type quiz_hide_results: string or None
        :param quiz_show_correct_answers: (optional) Only valid if hide_results=null If false, hides correct answers from students when quiz results are viewed. Defaults to true.
        :type quiz_show_correct_answers: boolean or None
        :param quiz_show_correct_answers_at: (optional) Only valid if show_correct_answers=true If set, the correct answers will be visible by students only after this date, otherwise the correct answers are visible once the student hands in their quiz submission.
        :type quiz_show_correct_answers_at: timestamp or None
        :param quiz_hide_correct_answers_at: (optional) Only valid if show_correct_answers=true If set, the correct answers will stop being visible once this date has passed. Otherwise, the correct answers will be visible indefinitely.
        :type quiz_hide_correct_answers_at: timestamp or None
        :param quiz_allowed_attempts: (optional) Number of times a student is allowed to take a quiz. Set to -1 for unlimited attempts. Defaults to 1.
        :type quiz_allowed_attempts: integer or None
        :param quiz_scoring_policy: (optional) Required and only valid if allowed_attempts > 1. Scoring policy for a quiz that students can take multiple times. Defaults to "keep_highest".
        :type quiz_scoring_policy: string or None
        :param quiz_one_question_at_a_time: (optional) If true, shows quiz to student one question at a time. Defaults to false.
        :type quiz_one_question_at_a_time: boolean or None
        :param quiz_cant_go_back: (optional) Only valid if one_question_at_a_time=true If true, questions are locked after answering. Defaults to false.
        :type quiz_cant_go_back: boolean or None
        :param quiz_access_code: (optional) Restricts access to the quiz with a password. For no access code restriction, set to null. Defaults to null.
        :type quiz_access_code: string or None
        :param quiz_ip_filter: (optional) Restricts access to the quiz to computers in a specified IP range. Filters can be a comma-separated list of addresses, or an address followed by a mask Examples: "192.168.217.1" "192.168.217.1/24" "192.168.217.1/255.255.255.0" For no IP filter restriction, set to null. Defaults to null.
        :type quiz_ip_filter: string or None
        :param quiz_due_at: (optional) The day/time the quiz is due. Accepts times in ISO 8601 format, e.g. 2011-10-21T18:48Z.
        :type quiz_due_at: timestamp or None
        :param quiz_lock_at: (optional) The day/time the quiz is locked for students. Accepts times in ISO 8601 format, e.g. 2011-10-21T18:48Z.
        :type quiz_lock_at: timestamp or None
        :param quiz_unlock_at: (optional) The day/time the quiz is unlocked for students. Accepts times in ISO 8601 format, e.g. 2011-10-21T18:48Z.
        :type quiz_unlock_at: timestamp or None
        :param quiz_published: (optional) Whether the quiz should have a draft state of published or unpublished. NOTE: If students have started taking the quiz, or there are any submissions for the quiz, you may not unpublish a quiz and will recieve an error.
