...
Defaults to false.
        ...
        :param quiz_only_visible_to_overrides: (optional) Whether this quiz is only visible to overrides (Only useful if
'differentiated assignments' account setting is on)
Defaults to false.
        :type quiz_only_visible_to_overrides: boolean or None
