...
def get_public_inline_preview_url(request_ctx, id, submission_id=None, **request_kwargs):
    """
    Determine the URL that should be used for inline preview of the file.
        ...
        :param id: (required) ID
        :type id: string
        :param submission_id: (optional) The id of the submission the file is associated with.  Provide this argument to gain access to a file
...
and the calling user has rights to view the submission).
        :type submission_id: integer or None
        :return: Get public inline preview url
        :rtype: requests.Response (with void data)
