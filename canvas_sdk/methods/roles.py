...
def create_new_role(request_ctx, account_id, label, role=None, base_role_type=None, permissions_X_explicit=None, permissions_X_enabled=None, permissions_X_locked=None, **request_kwargs):
    """
...
def update_role(request_ctx, account_id, id, label=None, permissions_X_explicit=None, permissions_X_enabled=None, **request_kwargs):
    """
