...
def edit_assignment(request_ctx, course_id, id, assignment_grading_standard_id=None, **request_kwargs):
    """
...
def redirect_to_the_assignment_override_for_group(request_ctx, group_id, assignment_id, **request_kwargs):
    """
...
def redirect_to_the_assignment_override_for_section(request_ctx, course_section_id, assignment_id, **request_kwargs):
    """
