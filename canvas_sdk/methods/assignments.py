...
def list_assignments(request_ctx, course_id, include=None, search_term=None, override_assignment_dates=None, needs_grading_count_by_section=None, bucket=None, assignment_ids=None, per_page=None, **request_kwargs):
    """
...
"observed_users" is passed, submissions for observed users will also be included as an array.
        ...
        :param assignment_ids: (optional) if set, return only assignments specified
    ...
    bucket_types = ('past', 'overdue', 'undated', 'ungraded', 'unsubmitted', 'upcoming', 'future')
...
Will be ignored if Turnitin is not available for the course.
        ...
        :param assignment_vericite_enabled: (optional) Only applies when the VeriCite plugin is enabled for a course and
the submission_types array includes "online_upload".
Toggles VeriCite submissions for the assignment.
Will be ignored if VeriCite is not available for the course.
        :type assignment_vericite_enabled: boolean or None
...
assign scores to each member of the group.
        ...
        :param assignment_external_tool_tag_attributes: (optional) Hash of external tool parameters if submission_types is ["external_tool"].
...
This will update the grading_type for the course to 'letter_grade' unless it is already 'gpa_scale'.
        ...
        :param assignment_omit_from_final_grade: (optional) Whether this assignment is counted towards a student's final grade.
        :type assignment_omit_from_final_grade: boolean or None
...
def edit_assignment(request_ctx, course_id, id, assignment_name=None, assignment_position=None, assignment_submission_types=None, assignment_allowed_extensions=None, assignment_turnitin_enabled=None, assignment_vericite_enabled=None, assignment_turnitin_settings=None, assignment_integration_data=None, assignment_integration_id=None, assignment_peer_reviews=None, assignment_automatic_peer_reviews=None, assignment_notify_of_update=None, assignment_group_category_id=None, assignment_grade_group_students_individually=None, assignment_external_tool_tag_attributes=None, assignment_points_possible=None, assignment_grading_type=None, assignment_due_at=None, assignment_lock_at=None, assignment_unlock_at=None, assignment_description=None, assignment_assignment_group_id=None, assignment_muted=None, assignment_assignment_overrides=None, assignment_only_visible_to_overrides=None, assignment_published=None, assignment_grading_standard_id=None, assignment_omit_from_final_grade=None, **request_kwargs):
    """
...
def batch_retrieve_overrides_in_course(request_ctx, course_id, assignment_overrides_id, assignment_overrides_assignment_id, per_page=None, **request_kwargs):
    """
    ...
    Returns null elements in the list for requests that were not found.
        ...
        :param course_id: (required) ID
        :type course_id: string
        :param assignment_overrides_id: (required) Ids of overrides to retrieve
        :type assignment_overrides_id: array
        :param assignment_overrides_assignment_id: (required) Ids of assignments for each override
        :type assignment_overrides_assignment_id: array
        :param per_page: (optional) Set how many results canvas should return, defaults to config.LIMIT_PER_PAGE
        :type per_page: integer or None
        :return: Batch retrieve overrides in a course
        :rtype: requests.Response (with array data)
...
def batch_create_overrides_in_course(request_ctx, course_id, assignment_overrides, per_page=None, **request_kwargs):
    """
    ...
    to inputs.  Global errors will be reported as a single element errors array
        ...
        :param course_id: (required) ID
        :type course_id: string
        :param assignment_overrides: (required) Attributes for the new assignment overrides.
See {api:AssignmentOverridesController#create Create an assignment override} for available
attributes
        :type assignment_overrides: array
        :param per_page: (optional) Set how many results canvas should return, defaults to config.LIMIT_PER_PAGE
        :type per_page: integer or None
        :return: Batch create overrides in a course
        :rtype: requests.Response (with array data)
...
def batch_update_overrides_in_course(request_ctx, course_id, assignment_overrides, per_page=None, **request_kwargs):
    """
    ...
    See `AssignmentOverridesController#update <https://github.com/instructure/canvas-lms/blob/master/app/controllers/assignment_overrides_controller.rb>`_ for
    ...
    to inputs.  Global errors will be reported as a single element errors array
        ...
        :param course_id: (required) ID
        :type course_id: string
        :param assignment_overrides: (required) Attributes for the updated overrides.
        :type assignment_overrides: array
        :param per_page: (optional) Set how many results canvas should return, defaults to config.LIMIT_PER_PAGE
        :type per_page: integer or None
        :return: Batch update overrides in a course
        :rtype: requests.Response (with array data)
