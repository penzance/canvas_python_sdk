...
def create_user_login(request_ctx, account_id, user_id, login_unique_id, login_password=None, login_sis_user_id=None, login_authentication_provider_id=None, **request_kwargs):
    """
