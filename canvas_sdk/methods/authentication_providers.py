...
def list_authentication_providers(request_ctx, account_id, per_page=None, **request_kwargs):
    """
...
def add_authentication_provider(request_ctx, account_id, **request_kwargs):
    """
...
def update_authentication_provider(request_ctx, account_id, id, **request_kwargs):
    """
...
def get_authentication_provider(request_ctx, account_id, id, **request_kwargs):
    """
...
def delete_authentication_provider(request_ctx, account_id, id, **request_kwargs):
    """
    Delete the config
