...
def set_feature_flag_courses(request_ctx, course_id, feature, state=None, **request_kwargs):
    """
...
def set_feature_flag_accounts(request_ctx, account_id, feature, state=None, **request_kwargs):
    """
    Set a feature flag for a given Account, Course, or User. This call will fail if a parent account sets
    a feature flag for the same feature in any state other than "allowed".
...
def set_feature_flag_users(request_ctx, user_id, feature, state=None, **request_kwargs):
    """
    Set a feature flag for a given Account, Course, or User. This call will fail if a parent account sets
    a feature flag for the same feature in any state other than "allowed".
