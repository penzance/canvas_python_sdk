...
def list_discussion_topics_courses(request_ctx, course_id, include=None, order_by=None, scope=None, only_announcements=None, search_term=None, exclude_context_module_locked_topics=None, per_page=None, **request_kwargs):
    """
    Returns the paginated list of discussion topics for this course or group.
        ...
        :param include: (optional) If "all_dates" is passed, all dates associated with graded discussions'
...
Can pass multiple states as comma separated string.
        ...
        :param exclude_context_module_locked_topics: (optional) For students, exclude topics that are locked by module progression.
Defaults to false.
        :type exclude_context_module_locked_topics: boolean or None
...
def list_discussion_topics_groups(request_ctx, group_id, include=None, order_by=None, scope=None, only_announcements=None, search_term=None, exclude_context_module_locked_topics=None, per_page=None, **request_kwargs):
    """
    Returns the paginated list of discussion topics for this course or group.
