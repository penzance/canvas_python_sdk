...
def create_enrollment_term(request_ctx, account_id, enrollment_term_name=None, enrollment_term_start_at=None, enrollment_term_end_at=None, enrollment_term_sis_term_id=None, enrollment_term_overrides_enrollment_type_start_at=None, enrollment_term_overrides_enrollment_type_end_at=None, **request_kwargs):
    """
...
Accepts times in ISO 8601 format, e.g. 2015-01-10T18:48:00Z.
        ...
        :param enrollment_term_overrides_enrollment_type_start_at: (optional) The day/time the term starts, overridden for the given enrollment type.
*enrollment_type* can be one of StudentEnrollment, TeacherEnrollment, TaEnrollment, or DesignerEnrollment
        :type enrollment_term_overrides_enrollment_type_start_at: DateTime or None
        :param enrollment_term_overrides_enrollment_type_end_at: (optional) The day/time the term ends, overridden for the given enrollment type.
*enrollment_type* can be one of StudentEnrollment, TeacherEnrollment, TaEnrollment, or DesignerEnrollment
        :type enrollment_term_overrides_enrollment_type_end_at: DateTime or None
...
def update_enrollment_term(request_ctx, account_id, id, **request_kwargs):
    """
    Update an existing enrollment term for the specified account.
    
    See the `TermsController#create <https://github.com/instructure/canvas-lms/blob/master/app/controllers/terms_controller.rb>`_ endpoint for a list of accepted arguments.
...
def list_enrollment_terms(request_ctx, account_id, workflow_state=None, include=None, per_page=None, **request_kwargs):
    """
