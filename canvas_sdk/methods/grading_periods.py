...
def get_single_grading_period(request_ctx, course_id, id, **request_kwargs):
    """
...
def update_single_grading_period(request_ctx, course_id, id, grading_periods_start_date, grading_periods_end_date, grading_periods_weight=None, **request_kwargs):
    """
    Update an existing grading period.
        ...
        :param grading_periods_weight: (optional) A weight value that contributes to the overall weight of a grading period set which is used to calculate how much assignments in this period contribute to the total grade
