...
def list_course_sections(request_ctx, course_id, include=None, per_page=None, **request_kwargs):
    ...
    Returns the list of sections for this course.
        ...
        :param include: (optional) - "students": Associations to include with the group. Note: this is only
...
- "passback_status": Include the grade passback status.
    ...
    include_types = ('students', 'avatar_url', 'enrollments', 'total_students', 'passback_status')
...
def create_course_section(request_ctx, course_id, course_section_name=None, course_section_sis_section_id=None, course_section_start_at=None, course_section_end_at=None, course_section_restrict_enrollments_to_section_dates=None, enable_sis_reactivation=None, **request_kwargs):
    """
    Creates a new section for this course.
        ...
        :param course_section_restrict_enrollments_to_section_dates: (optional) Set to true to restrict user enrollments to the start and end dates of the section.
        :type course_section_restrict_enrollments_to_section_dates: boolean or None
        :param enable_sis_reactivation: (optional) When true, will first try to re-activate a deleted section with matching sis_section_id if possible.
...
def edit_section(request_ctx, id, course_section_name=None, course_section_sis_section_id=None, course_section_start_at=None, course_section_end_at=None, course_section_restrict_enrollments_to_section_dates=None, **request_kwargs):
    """
...
def get_section_information_courses(request_ctx, course_id, id, include=None, **request_kwargs):
    """
...
def get_section_information_sections(request_ctx, id, include=None, **request_kwargs):
    """
    Gets details about a specific section
