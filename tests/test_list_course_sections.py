...
class TestListCourseSections(unittest.TestCase):
    ...
    def test_get_action(self):
        ...
        self.assertEquals(action, ListCourseSections.ACTION, "Result of get_action call should match class action attribute")

    def test_path_property(self):
        path = self.api_method.path
        self.assertEquals(path, ListCourseSections._path.format(course_id=self.test_course_id), "path should be a formatted version of 'private' _path class variable with course_id substitution")
    ...
    def test_include_getter_setter_against_valid_values(self):
        for value in ListCourseSections.INCLUDE_TYPES:
            ...
            self.assertEquals(value, self.api_method.include, "Include property should match what was set for valid values")

    def test_include_getter_setter_with_none(self):
        self.api_method.include = None
        self.assertEquals(None, self.api_method.include, "Include property should allow for value set to 'None'")
