...
class TestUtils(unittest.TestCase):
    ...
    def test_format_sis_id_called_with_int_value(self):
        """
        Assert that format_sis_id returns the value passed in if it's an integer
        """
        test_param = 'account_id'
        test_value = 1234
        value = utils.format_sis_id(test_param, test_value)
        self.assertEqual(test_value, value)

    def test_format_sis_id_called_with_str_sis_value(self):
        """
        Assert that format_sis_id returns the value passed in if it's a string that contains sis
        """
        test_param = 'sis_account_id'
        test_value = 'ext'
        value = utils.format_sis_id(test_param, test_value)
        self.assertEqual(test_value, value)

    def test_format_sis_id_called_with_null_value(self):
        """
        Assert that format_sis_id returns None if value is None
        """
        test_param = 'sis_account_id'
        test_value = None
        value = utils.format_sis_id(test_param, test_value)
    ...
    def test_format_sis_id_called_with_null_param_name(self):
        """
        Assert that format_sis_id returns None if param_name is None
        """
        test_param = None
        test_value = 'ext'
        value = utils.format_sis_id(test_param, test_value)
    ...
    def test_format_sis_id_called_with_valid_string_value_returns_correct_value(self):
        """
        Assert that format_sis_id returns correct value when valid string is passed in
        """
        test_param = 'account_id'
        test_value = 'ext'
        value = utils.format_sis_id(test_param, test_value)
        self.assertEqual(value, 'sis_account_id:ext')
